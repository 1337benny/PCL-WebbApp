...
{
    /// <inheritdoc />
    public partial class AfterMySqlSwitchMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListTasks_Checklists_ChecklistID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientHasProjects", x => new { x.ProjectID, x.ClientID });
                    table.ForeignKey(
                        name: "FK_ClientHasProjects_Clients_ClientID",
                        column: x => x.ClientID,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientHasProjects_Projects_ProjectID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectHasChecklists", x => new { x.ProjectID, x.ChecklistID });
                    table.ForeignKey(
                        name: "FK_ProjectHasChecklists_Checklists_ChecklistID",
                        column: x => x.ChecklistID,
                        principalTable: "Checklists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectHasChecklists_Projects_ProjectID",
                        column: x => x.ProjectID,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientHasProjects_ClientID",
                table: "ClientHasProjects",
                column: "ClientID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListTasks_ChecklistID",
                table: "ListTasks",
                column: "ChecklistID");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectHasChecklists_ChecklistID",
                table: "ProjectHasChecklists",
                column: "ChecklistID");
